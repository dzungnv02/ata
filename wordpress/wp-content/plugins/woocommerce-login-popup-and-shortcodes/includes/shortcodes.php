					...
					<?php
						if( is_user_logged_in() ){ ?>
							<div id="woo_login_popup_sc_loggedin">
								<h2><?php _e( 'Tài khoản', 'woo-login-popup-shortcodes' ); ?></h2>
								<p><?php echo apply_filters( 'woo_login_popup_sc_loggedin_text', __( '
Bạn đã đăng nhập thành công! Sử dụng các liên kết bên dưới để điều hướng qua các trang tài khoản của bạn.', 'woo-login-popup-shortcodes' ) ); ?></p>
